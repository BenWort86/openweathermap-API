...
from openweathermap.weather_forecast import run  # forecast collection function
...
# Define DAG
with DAG(
    dag_id='weather_forecast',  # unique DAG id
    ...
    # Task: run the forecast collection script
    run_job = PythonOperator(
        task_id='weather_forecast',  # task id
